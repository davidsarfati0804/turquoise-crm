        ...
        <div className="flex items-center space-x-4">
          ...
          <form onSubmit={handleSearch} className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 w-64 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-turquoise-500 focus:border-transparent bg-gray-50"
            />
          </form>
